...
%WN
In our MQW perovskite system, we do not observe pure excitons in the spectra. Instead localised excitons in periodically-spaced nearby QWs are optically coupled together to form collective states an average distance $l$ from the Ag surface \cite{Pbbr2008, Baumberg1998, Kavokin1998, Vladimirova1998}. These states interact with the photon modes of the thin CHPI coating to create guided exciton-polaritons along the film, and these normally evanescent modes couple to outgoing photons via the grating or surface roughness. %end
...
with a binding energy of 100\,meV at room temperature. The biexcitons do not emit directly to photons but to SPPs on the Ag surface, and this signal is outcoupled to the far-field via the grating [Fig.\,\ref{7Fig16}(b)]. %end
...
In the case of strong coupling at $\phi=90^{\circ}$, the time-averaged near-field %WN
of the SPP-like mode [Fig.\,\ref{7Fig18}(b)] shows a stronger intensity inside the CHPI that coats the bottom surface of the grating compared to the exciton-like mode [Fig.\,\ref{7Fig18}(c)] as a result of evanescent decay from the metal surface. %end
