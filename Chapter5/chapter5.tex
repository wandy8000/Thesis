...
\nomenclature[zPAPI]{PAPI}{\ce{(C6H5C2H4NH3)2PbI4}}
\nomenclature[zMWQ]{MQW}{Multiple quantum well}
\nomenclature[zBF]{BF}{Bright field}
\nomenclature[zDF]{DF}{Dark field}
\nomenclature[z2D]{2D}{Two-dimensional}
\nomenclature[zAFM]{AFM}{Atomic force microscopy}
...
\nomenclature[zXRD]{XRD}{X-ray diffraction}
\nomenclature[zPbI]{PbI}{Lead (II) iodide}
...
\nomenclature[ch]{$h$}{Planck constant, $6.626\times10^{-34}$\,Js}
...
Spectroscopic measurements of flake thickness require detailed knowledge of the CHPI refractive index, which is not well known. Instead we extract the required information from reflectivity data using the transfer matrix formulation \cite{Born1999}. In the wavelength range of interest (460\,-\,750\,nm), the dielectric function $\epsilon$ of 2D PbI perovskites can be modelled as the sum of a constant background and two Lorentzian oscillators: the exciton ($ex$) and an additional charge transfer ($CT$) transition %WN
between the organic and inorganic layers %end
at $\sim\negmedspace400$\,nm \cite{VijayaPrakash2009, Fujisawa2004, Fujisawa2005, Fujisawa2007, Mitzi1999a, Zhang2010}. %WN
The two oscillators do not couple to each other, and we expect addition of these resonances in the spectra shown in Fig.\,\ref{5Fig3}(d). %end
Hence
\begin{equation}
\centering
